            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="current_password" class="col-md-4 col-form-label text-md-end">Jelenlegi jelszó</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Csak jelszó módosításához szükséges</small>
                        ...
                        <div class="mb-3 row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Új jelszó megerősítése</label>
